...
pub const git_remote_ready_cb = ?fn (?*git_remote, c_int, ?*anyopaque) callconv(.C) c_int;
...
pub extern fn git_oidarray_dispose(array: [*c]git_oidarray) void;
...
pub extern fn git_remote_set_instance_url(remote: ?*git_remote, url: [*c]const u8) c_int;
pub extern fn git_remote_set_instance_pushurl(remote: ?*git_remote, url: [*c]const u8) c_int;
...
pub const git_commit_create_cb = ?fn ([*c]git_oid, [*c]const git_signature, [*c]const git_signature, [*c]const u8, [*c]const u8, ?*const git_tree, usize, [*c]?*const git_commit, ?*anyopaque) callconv(.C) c_int;
...
pub const git_rebase_options = extern struct {
    ...
    signing_cb: ?fn ([*c]git_buf, [*c]git_buf, [*c]const u8, ?*anyopaque) callconv(.C) c_int,
    payload: ?*anyopaque,
};
...
pub extern fn git_email_create_from_diff(out: [*c]git_buf, diff: ?*git_diff, patch_idx: usize, patch_count: usize, commit_id: [*c]const git_oid, summary: [*c]const u8, body: [*c]const u8, author: [*c]const git_signature, opts: [*c]const git_email_create_options) c_int;
pub extern fn git_email_create_from_commit(out: [*c]git_buf, commit: ?*git_commit, opts: [*c]const git_email_create_options) c_int;
...
pub extern fn git_odb_write_multi_pack_index(db: ?*git_odb) c_int;
...
pub const GIT_EXTERN = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // vendor/zig-libgit2/libgit2/include/git2/common.h:39:10
pub const GIT_DEPRECATED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // vendor/zig-libgit2/libgit2/include/git2/common.h:57:10
pub const GIT_FORMAT_PRINTF = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // vendor/zig-libgit2/libgit2/include/git2/common.h:69:10
pub const GIT_BUF_INIT_CONST = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/buffer.h:66:9
pub const GIT_REPOSITORY_INIT_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/repository.h:357:9
pub const GIT_DIFF_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/diff.h:455:9
pub const GIT_DIFF_FIND_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/diff.h:789:9
pub const GIT_DIFF_PATCHID_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/diff.h:1390:9
pub const GIT_APPLY_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/apply.h:90:9
pub const GIT_ATTR_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/attr.h:164:9
pub const GIT_BLOB_FILTER_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/blob.h:152:9
pub const GIT_BLAME_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/blame.h:126:9
pub const GIT_CHECKOUT_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/checkout.h:345:9
pub const GIT_INDEXER_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/indexer.h:76:9
pub const GIT_INDEX_ENTRY_STAGE_SET = @compileError("unable to translate C expr: unexpected token 'do'"); // vendor/zig-libgit2/libgit2/include/git2/index.h:95:9
pub const GIT_MERGE_FILE_INPUT_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/merge.h:49:9
pub const GIT_MERGE_FILE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/merge.h:203:9
pub const GIT_MERGE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/merge.h:298:9
pub const GIT_CHERRYPICK_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/cherrypick.h:37:9
pub const GIT_PROXY_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/proxy.h:82:9
pub const GIT_REMOTE_CREATE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/remote.h:85:9
pub const GIT_REMOTE_CALLBACKS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/remote.h:641:9
pub const GIT_FETCH_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/remote.h:744:9
pub const GIT_PUSH_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/remote.h:795:9
pub const GIT_CLONE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/clone.h:167:9
pub const GIT_DESCRIBE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/describe.h:67:9
pub const GIT_DESCRIBE_FORMAT_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/describe.h:114:9
pub const GIT_FILTER_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/filter.h:83:10
pub const GIT_REBASE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/rebase.h:159:9
pub const GIT_REVERT_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/revert.h:37:9
pub const GIT_STASH_APPLY_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/stash.h:141:9
pub const GIT_STATUS_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/status.h:256:9
pub const GIT_SUBMODULE_UPDATE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/submodule.h:156:9
pub const GIT_WORKTREE_ADD_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/worktree.h:92:9
pub const GIT_WORKTREE_PRUNE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/worktree.h:206:9
pub const GIT_DIFF_FORMAT_EMAIL_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/deprecated.h:349:9
pub const GIT_EMAIL_CREATE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'"); // vendor/zig-libgit2/libgit2/include/git2/email.h:78:9
...
pub const INCLUDE_git_git_h__ = "";
pub const INCLUDE_git_annotated_commit_h__ = "";
pub const INCLUDE_git_common_h__ = "";
...
pub const GIT_BEGIN_DECL = "";
pub const GIT_END_DECL = "";
...
pub const INCLUDE_git_repository_h__ = "";
pub const INCLUDE_git_types_h__ = "";
pub const INCLUDE_git_buf_h__ = "";
pub const INCLUDE_git_oid_h__ = "";
...
pub const INCLUDE_git_apply_h__ = "";
pub const INCLUDE_git_diff_h__ = "";
pub const INCLUDE_git_tree_h__ = "";
pub const INCLUDE_git_object_h__ = "";
pub const GIT_OBJECT_SIZE_MAX = UINT64_MAX;
pub const INCLUDE_git_refs_h__ = "";
pub const INCLUDE_git_strarray_h__ = "";
...
pub const INCLUDE_git_attr_h__ = "";
...
pub const INCLUDE_git_blob_h__ = "";
pub const GIT_BLOB_FILTER_OPTIONS_VERSION = @as(c_int, 1);
pub const INCLUDE_git_blame_h__ = "";
pub const GIT_BLAME_OPTIONS_VERSION = @as(c_int, 1);
pub const INCLUDE_git_branch_h__ = "";
pub const INCLUDE_git_cert_h__ = "";
pub const INCLUDE_git_checkout_h__ = "";
pub const GIT_CHECKOUT_OPTIONS_VERSION = @as(c_int, 1);
pub const INCLUDE_git_cherrypick_h__ = "";
pub const INCLUDE_git_merge_h__ = "";
pub const INCLUDE_git_oidarray_h__ = "";
pub const INCLUDE_git_index_h__ = "";
pub const _INCLUDE_git_indexer_h__ = "";
...
pub const INCLUDE_git_clone_h__ = "";
pub const INCLUDE_git_remote_h__ = "";
pub const INCLUDE_git_refspec_h__ = "";
pub const INCLUDE_git_net_h__ = "";
pub const GIT_DEFAULT_PORT = "9418";
pub const INCLUDE_git_transport_h__ = "";
pub const INCLUDE_git_credential_h__ = "";
pub const INCLUDE_git_pack_h__ = "";
pub const INCLUDE_git_proxy_h__ = "";
...
pub const INCLUDE_git_commit_h__ = "";
pub const INCLUDE_git_config_h__ = "";
pub const INCLUDE_git_deprecated_h__ = "";
pub const INCLUDE_git_describe_h__ = "";
...
pub const INCLUDE_git_errors_h__ = "";
pub const INCLUDE_git_filter_h__ = "";
pub const GIT_FILTER_OPTIONS_VERSION = @as(c_int, 1);
pub const INCLUDE_git_rebase_h__ = "";
pub const GIT_REBASE_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_REBASE_NO_OPERATION = SIZE_MAX;
pub const INCLUDE_git_trace_h__ = "";
pub const INCLUDE_git_revert_h__ = "";
pub const GIT_REVERT_OPTIONS_VERSION = @as(c_int, 1);
pub const INCLUDE_git_revparse_h__ = "";
pub const INCLUDE_git_stash_h__ = "";
pub const GIT_STASH_APPLY_OPTIONS_VERSION = @as(c_int, 1);
pub const INCLUDE_git_status_h__ = "";
...
pub const INCLUDE_git_submodule_h__ = "";
...
pub const INCLUDE_git_worktree_h__ = "";
pub const GIT_WORKTREE_ADD_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_WORKTREE_PRUNE_OPTIONS_VERSION = @as(c_int, 1);
pub const INCLUDE_git_credential_helpers_h__ = "";
pub const INCLUDE_sys_git_credential_h__ = "";
...
pub const INCLUDE_git_email_h__ = "";
pub const GIT_EMAIL_CREATE_OPTIONS_VERSION = @as(c_int, 1);
pub const INCLUDE_git_global_h__ = "";
pub const INCLUDE_git_graph_h__ = "";
pub const INCLUDE_git_ignore_h__ = "";
pub const INCLUDE_git_mailmap_h__ = "";
pub const INCLUDE_git_message_h__ = "";
pub const INCLUDE_git_note_h__ = "";
pub const INCLUDE_git_odb_h__ = "";
pub const INCLUDE_git_odb_backend_h__ = "";
pub const INCLUDE_git_patch_h__ = "";
pub const INCLUDE_git_pathspec_h__ = "";
pub const INCLUDE_git_refdb_h__ = "";
pub const INCLUDE_git_reflog_h__ = "";
pub const INCLUDE_git_reset_h__ = "";
pub const INCLUDE_git_revwalk_h__ = "";
pub const INCLUDE_git_signature_h__ = "";
pub const INCLUDE_git_tag_h__ = "";
pub const INCLUDE_git_transaction_h__ = "";
pub const INCLUDE_git_version_h__ = "";
pub const LIBGIT2_VERSION = "1.3.0";
pub const LIBGIT2_VER_MAJOR = @as(c_int, 1);
pub const LIBGIT2_VER_MINOR = @as(c_int, 3);
pub const LIBGIT2_VER_REVISION = @as(c_int, 0);
pub const LIBGIT2_VER_PATCH = @as(c_int, 0);
pub const LIBGIT2_SOVERSION = "1.3";
